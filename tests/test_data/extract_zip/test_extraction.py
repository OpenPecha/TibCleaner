...
def test_zip_rename_extract():
    ...
    output_dir = Path("tests/test_data/extract_zip/zip_rename_extract")
...
def test_zip_extract():
    folder_dir = Path("tests/test_data/ALL_FILES/")
    output_dir = Path("tests/test_data/extract_zip/zip_extract")
    zip_files = list(folder_dir.rglob("*.zip"))
...
def test_rar_extract():
    folder_dir = Path("tests/test_data/ALL_FILES/")
    output_dir = Path("tests/test_data/extract_zip/rar_extract")
