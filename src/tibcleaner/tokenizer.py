...
import botok
import chardet  # Import at the top of your script
...
def process_text(args):
    ...
    try:
        ...
        with open(txt_file, "rb") as f:
            raw_data = f.read(4 * 1024)  # Reading the first 4KB to guess the encoding
...
if __name__ == "__main__":
    data_dir = Path("./data/ALL_FILES")
    output_dir = Path("./data/tokenized_text")
    txt_files = list(data_dir.rglob("*.TXT")) + list(data_dir.rglob("*.txt"))
